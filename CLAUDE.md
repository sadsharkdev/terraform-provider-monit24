...
Ten resources are registered in `monit24/provider.go`, tracking Monit24 API v3.51 (see `docs-internal/api-inventory.md` for the full endpoint inventory this was audited against, and `docs/superpowers/specs/2026-08-14-full-api-v3.51-coverage-design.md` for the design driving ongoing work):
